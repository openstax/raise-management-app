...
class CognitoJWTBearer(HTTPBearer):
    ...
    async def __call__(
        ...
        # in the parent class. We still need to verify the token.
        ...
        username = verified_claims.get(COGNITO_USERNAME_CLAIM, "")
        user_groups = verified_claims.get(COGNITO_GROUPS_CLAIM, [])
